      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center gap-4">
            <Button variant="outline" className="flex-1" onClick={() => handleVote(true)} disabled={loading}>
              {loading ? (
            ...
            <Button variant="outline" className="flex-1" onClick={() => handleVote(false)} disabled={loading}>
              {loading ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
                <>
